...
public class Activator implements BundleActivator
{
  ...
  public void start(BundleContext context) throws Exception
  {
    ...
    // then register our service, which provides new tab for material in OB
    context.registerService(PluginObjectBrowserTabService.class, new MyTabServiceFactory(ectrService), null);
  }
